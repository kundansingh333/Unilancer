...
// // --- FIX: Corrected ratingDistribution Logic ---
...
// // --- REMOVED THE NESTED/DUPLICATE averageRating VIRTUAL ---
// // You already have averageRating as a Schema field calculated in 'pre save'.
// // Having it as a virtual too can cause conflicts, but if you really want it
// // dynamic, uncomment below. I recommend sticking to the Schema field for performance.

// /* gigSchema.virtual("averageRatingVirtual").get(function () {
//   if (!this.reviews || this.reviews.length === 0) return 0;
//   let total = 0;
//   this.reviews.forEach((r) => { total += r.rating; });
