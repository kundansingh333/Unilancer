...
const CreateEventPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 pb-20">
      <SEO title="Create Event" path="/events/create" noIndex />
        ...
        <div className="max-w-4xl mx-auto px-4 py-4 sm:px-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Publish a hackathon, workshop, or campus event</p>
            </div>
          </div>
          <button
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 mt-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <section className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 sm:p-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input name="organizer" value={form.organizer} onChange={handleChange} required placeholder="Club or Individual name" className="w-full bg-slate-950/50 border border-slate-700 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-amber-500/50 transition-all outline-none" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-2">Contact Email</label>
                  <input type="email" name="email" value={form.organizerContact.email} onChange={handleOrganizerContact} placeholder="contact@example.com" className="w-full bg-slate-950/50 border border-slate-700 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-amber-500/50 transition-all outline-none" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-2">Contact Phone</label>
                  <input type="tel" name="phone" value={form.organizerContact.phone} onChange={handleOrganizerContact} placeholder="10-digit number" pattern="[0-9]{10}" className="w-full bg-slate-950/50 border border-slate-700 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-amber-500/50 transition-all outline-none" />
                </div>
              </div>
            </section>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="number" name="capacity" value={form.capacity} onChange={handleChange} min="1" required placeholder="0 for unlimited" className="w-full bg-slate-950/50 border border-slate-700 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-rose-500/50 transition-all outline-none" />
                  </div>
                </div>
              </div>
            </section>
          ...
          <div className="pt-6 sm:hidden">
            ...
            >
              {isLoading ? <Loader2 className="w-5 h-5 animate-spin" /> : "Publish Event"}
            </button>
          </div>
