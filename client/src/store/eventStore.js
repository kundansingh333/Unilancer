...
//       set({ featuredEvents: res.data.events });
//     } catch (err) {
//       set({
...
//       set({
//         myOrganizedEvents: res.data.events,
//         isLoading: false,
//       });
//     } catch (err) {
//       set({
...
//       if (!res.data.success) {
//         throw new Error(res.data.error || "Failed to load registered events");
//       }

//       set({
//         myRegisteredEvents: res.data.registrations,
//         isLoading: false,
//       });
//     } catch (err) {
//       console.error("My registered events error:", err);
//       set({
//         error: err?.response?.data?.error || err.message,
//         isLoading: false,
//       });
...
//       set({ currentEvent: res.data.event, isLoading: false });
...
//   // markAttendance: async (id, userId, data) => {
//   //   const res = await eventsApi.markAttendance(id, userId, data);
//   //   return res.data;
//   // },

//   markUserAttendance: async (eventId, userId, attended) => {
//     try {
//       const res = await eventsApi.markAttendance(eventId, userId, attended);
